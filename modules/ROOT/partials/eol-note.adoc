...
// tag::eolReached[]
This product has reached https://www.mulesoft.com/legal/versioning-back-support-policy[End of Life^] and is no longer supported.
// end::eolReached[]
...
This feature of the product has entered https://www.mulesoft.com/legal/versioning-back-support-policy[Extended Support^].
