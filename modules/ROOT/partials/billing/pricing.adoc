...
[[visualizer-widget]]
NOTE: Anypoint Visualizer app network integration refers to features in the *Application Network* tab within Anypoint Monitoring. Outside of Anypoint Monitoring, the product Anypoint Visualizer is available to organizations at all core-based subscription tiers (Gold, Platinum, Titanium). 
