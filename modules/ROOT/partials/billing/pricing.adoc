...
|===
*Feature available in these tiers:* xref:monitoring::index.adoc#billing[Advanced usage and Subscription-based tiers]
|===
...
|===
*Feature available in:* xref:monitoring::index.adoc#billing[Varies by usage or subscription tier]
|===
