...
* US and EU regions: Overview, Inbound, Outbound, Performance, Failures, JVM, and Infrastructure
* Canada and Japan Hyperforce regions (Anypoint Insights): Overview, Request, Errors, JVM
...
* US and EU regions (Built-in): Overview, Requests, Failures, Performance, and Client Application 
* Canada and Japan Hyperforce regions (Anypoint Insights): Overview, Request, Errors, JVM
...
//NEW: TODO_TODO_TODO: what does "distributed" mean here?
...
//NEW: Log tailing: recent data from a log file
|Log tailing
|Yes
|Yes
...
//TBD_TBD_TBD: is support correct?
|Enhanced Support
|No
|Yes

3+| *Dashboards with Aggregated Metrics Across Deployments (Anypoint Insights)*
|Out-of-the-box charts with aggregated metrics:

* US and EU regions: Not available at this time
* Canada and Japan Hyperforce regions (Anypoint Insights): Performance metrics and trends for CloudHub 2.0 and Runtime Fabric deployments

See also, built-in dashboards for individual APIs and apps.
| Yes
| No
