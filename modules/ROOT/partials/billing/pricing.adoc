...
For https://ca1.platform.mulesoft.com/monitoring/[JP (Japan)] and https://ca1.platform.mulesoft.com/monitoring/[CA (Canada)] regions, use the *Anypoint Insights* starter package feature.
|Yes
|Yes
