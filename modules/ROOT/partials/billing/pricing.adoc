...
For Anypoint Platform regions in https://ca1.platform.mulesoft.com/monitoring/[Canada (CA)] and https://ca1.platform.mulesoft.com/monitoring/[Japan (JP)], use the *Anypoint Insights* starter package feature.
|Yes
|Yes
