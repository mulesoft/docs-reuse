...
For https://ca1.platform.mulesoft.com/monitoring/[JP (Japan)] and https://ca1.platform.mulesoft.com/monitoring/[CA (Canada)] Anypoint Platform regions, use the *Anypoint Insights* starter package.
|Yes
|Yes
