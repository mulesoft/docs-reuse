...
//TBD_TBD_TBD: Are built-in details correct here?
...
// MOVED Alerts to above, consolidated
// 3+| *Alerts*
//
// |Basic alerts
// |Yes
...
// MOVED FROM TOP OF PAGE TO HERE:
//// 
