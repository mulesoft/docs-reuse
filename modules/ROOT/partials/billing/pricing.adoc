...
3+| *Anypoint Insights Dashboards*
|Out-of-the-box charts for your deployments (entities):

* Charts with metrics across all your entities: Performance and Trends 
* Charts with metrics for individual entities: Overview, Request, Errors, JVM

Anypoint Insights is not available in the US and EU regions at this time. 
