...
|Many out-of-the-box charts covering metrics in the following categories: 

* US and EU regions: Overview, Inbound, Outbound, Performance, Failures, JVM, and Infrastructure
* CA and JA regions: Overview, Request, Errors, JVM
...
|Out-of-the-box charts covering these metrics: 

* US and EU regions: Overview, Requests, Failures, Performance, and Client Application 
* CA and JA regions: Overview, Request, Errors, JVM
...
| *Aggregated Metrics Across Deployments*
|Out-of-the-box charts in Anypoint Insights covering these metrics:

* US and EU regions: Not available at this time
* CA and JA regions: Performance metrics and trends
...
//TBD_TBD_TBD: entire category: what does "enhanced support" mean?
3+| *Enhanced Support*
