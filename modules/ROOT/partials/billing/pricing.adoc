...
For Anypoint Platform regions in https://ca1.platform.mulesoft.com/monitoring/[Canada (CA)] and https://jp1.platform.mulesoft.com/monitoring/[Japan (JP)], use the starter package feature, *Anypoint Insights*.
|Yes
|Yes
...
//UPDATED
|xref:monitoring::log-search-query-syntax.adoc[Log search in Runtime Manager]

* For Anypoint Platform regions in https://ca1.platform.mulesoft.com/monitoring/[Canada (CA)] and https://jp1.platform.mulesoft.com/monitoring/[Japan (JP)], you can navigate to Log Search in Runtime Manager. Only starter package Log Search is available. 
