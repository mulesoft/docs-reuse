...
|===
|*Feature available in these tiers*: xref:monitoring::index.adoc#billing[Advanced usage plan and Titanium subscription package]
|===
// end::featureAdvReqMonitoring[]

// tag::featureAdvSubReqMonitoring[]
|===
*Feature available in these tiers:* xref:monitoring::index.adoc#billing[Advanced usage plan and Subscription-based packages]
|===
// end::featureAdvSubReqMonitoring[]

// tag::featureUsageTitReqMonitoring[]
|===
*Feature available in these tiers:* xref:monitoring::index.adoc#billing[Usage-based plans and Titanium subscription package]
|===
