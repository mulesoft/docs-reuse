...
* For Anypoint Platform in https://ca1.platform.mulesoft.com/monitoring/[Canada Cloud] and https://jp1.platform.mulesoft.com/monitoring/[Japan Cloud], use the Starter package feature, xref:anypoint-insights.adoc[Anypoint Insights].
|Yes
|Yes
...
//TEMP INFO: Hyperforce 12/24 (W-17225983)
* For Anypoint Platform regions in https://ca1.platform.mulesoft.com/monitoring/[Canada Cloud] and https://jp1.platform.mulesoft.com/monitoring/[Japan Cloud], use the Starter package feature, xref:anypoint-insights.adoc[Anypoint Insights].
...
//TEMP INFO: Hyperforce 12/24 (W-17225983)
* To use this feature from Anypoint Platform in https://ca1.platform.mulesoft.com/monitoring[Canada Cloud] and https://jp1.platform.mulesoft.com/monitoring[Japan Cloud], navigate to Runtime Manager, and open *Logs*.
